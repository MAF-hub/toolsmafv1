...
if EDAD_DEL_GIL>=18 and EDAD_DEL_GIL<100:
  def menu():
    print '''
      ...
      {3}7.{1} {2} PANEL DEL ADMIN EN UNA WEB								
      {3}8.{1} {2} Youtube MAF					
      {3}9.{1}{2} Salir						
  ...
  if d == "4":
    print """
     ...
     """
  	...
  	os.system("clear")
  	system=raw_input(" esta en Linux? [Y]|[N] > ")
  	system_LOW=system.lower()
  	if system_LOW == "y":
  	   os.system("clear")
  	   asf= raw_input("ingrese la web > ")
  	   os.system("python3 panel/Panel.py " + str(asf))
  	elif system_LOW =="n":
  		os.system("apt install pip")
  		os.system("pip3 install requests")
  		os.system("clear")
  		pan=raw_input(" ingrese la web > ")
  		os.system("python3 panel/Panel.py " + str(pan))
